...
Response.Write("对不起，暂时还没有任何单页记录。")
else
...
%>
                  <tr> 
                    ...
                    <td><%=id%></td>
                    <td><a href="aboutedit.asp?id=<%=id%>" target="_blank" ><%=left(title,30)%></a></td> 
                    <td><%=a_time%></td>
                    <td><!-- Icons -->
                        <a href="aboutedit.asp?id=<%=id%>" title="Edit"><img src="images/images/icons/pencil.png" alt="Edit" /></a> <a href="aboutdelete.asp?id=<%=id%>" title="Delete"><img src="images/images/icons/cross.png" alt="Delete" /></a> </td>
                  </tr>
                  <%
rs.movenext
next
